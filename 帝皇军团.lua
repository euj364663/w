...
local Window = Library:new("帝皇军团 X");

local creds = Window:Tab("公告",'1984825722')
local bin = creds:section("信息",,)
local about = creds:section("作者",,)
